const privacy = {
  PRIVACY_TITLE: "Datenschutzerkärung",
  PRIVACY_BASICS_TITLE: "Grundlegendes",
  PRIVACY_BASICS: `Diese Datenschutzerklärung soll die Nutzer dieser Website über die Art,
    den Umfang und den Zweck der Erhebung und Verwendung personenbezogener
    Daten durch den Websitebetreiber (Kontaktdaten siehe Impressum)
  ...
  PRIVACY_DATA_COLLECTED_TITLE: "Zugriffsdaten",
  PRIVACY_DATA_COLLECTED_P1: `Wir, der Websitebetreiber bzw. Seitenprovider, erheben aufgrund
  ...
  so protokolliert:`,
  PRIVACY_DATA_COLLECTED_P2: `Die Server-Logfiles werden für maximal 7 Tage gespeichert und
  ...
  der Löschung ausgenommen bis der Vorfall endgültig geklärt ist. Diese
  ...
  RIGHTS_TITLE: "Rechte des Nutzers",
  RIGHTS: `Sie haben als Nutzer das Recht, auf Antrag eine kostenlose Auskunft
  ...
  DATA_DELETION_TITLE: "Löschung von Daten",
  DATA_DELETION: `Sofern Ihr Wunsch nicht mit einer gesetzlichen Pflicht zur
  ...
  DISAGREE_TITLE: "Widerspruchsrecht",
  DISAGREE: `Nutzer dieser Webseite können von ihrem Widerspruchsrecht Gebrauch
  ...
  E-Mail-Adresse: tonio.suessdorf at gmail.com.`,
};
